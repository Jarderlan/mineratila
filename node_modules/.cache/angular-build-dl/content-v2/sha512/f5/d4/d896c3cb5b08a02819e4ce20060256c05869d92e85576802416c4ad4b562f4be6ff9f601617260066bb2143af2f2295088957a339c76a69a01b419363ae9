...
const routes = [
    ...
    {
        path: 'produtos',
        loadChildren: () => __webpack_require__.e(/*! import() | produtos-produtos-module */ "produtos-produtos-module").then(__webpack_require__.bind(null, /*! ./produtos/produtos.module */ "./src/app/produtos/produtos.module.ts")).then(m => m.ProdutosPageModule)
    },
    {
        path: 'mpesados',
        loadChildren: () => __webpack_require__.e(/*! import() | mpesados-mpesados-module */ "mpesados-mpesados-module").then(__webpack_require__.bind(null, /*! ./mpesados/mpesados.module */ "./src/app/mpesados/mpesados.module.ts")).then(m => m.MpesadosPageModule)
    },
    {
        path: 'modal',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modal/modal.module */ "./src/app/modal/modal.module.ts")).then(m => m.ModalPageModule)
    }
];
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _modal_modal_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal/modal.module */ "./src/app/modal/modal.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _modal_modal_module__WEBPACK_IMPORTED_MODULE_1__["ModalPageModule"],
...
let ModalPage = class ModalPage {
    constructor(fBuilder, modalController, navParams, emailComposer, myplatform, alertController) {
        ...
        this.fGroup = this.fBuilder.group({
            'nome': [this.orcamento.nome, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(3)
                ])],
            'email': [this.orcamento.email, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/)
                ])],
            'empresa': [this.orcamento.empresa, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                ])],
            'cpfcnpj': [this.orcamento.cpfcnpj, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                ])],
            'fone': [this.orcamento.fone, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                ])],
            'descricao': [this.orcamento.descricao, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                ])]
        });
    }
    ...
    submitForm() {
        if (this.validacpf(this.fGroup.value['cpfcnpj'])) {
            //alert('CPF Valido');
            let isgmail = "Nome: " + this.fGroup.value['nome'] +
            ...
            let nogmail = "<html>Nome: " + this.fGroup.value['nome'] +
...
ModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        //app-modal
        selector: 'modal-page',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./modal.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modal/modal.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./modal.page.scss */ "./src/app/modal/modal.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavParams"],
        _ionic_native_email_composer_ngx__WEBPACK_IMPORTED_MODULE_1__["EmailComposer"],
...
module.exports = __webpack_require__(/*! /Users/jarderlan/Ionic/MineradoSideMenu/src/main.ts */"./src/main.ts");
