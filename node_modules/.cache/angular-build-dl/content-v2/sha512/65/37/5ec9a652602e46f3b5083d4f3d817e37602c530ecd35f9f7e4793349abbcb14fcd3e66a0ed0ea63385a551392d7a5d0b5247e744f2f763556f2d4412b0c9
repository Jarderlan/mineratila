...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModalModalPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ModalPage(fBuilder, modalController, navParams, emailComposer, myplatform, alertController) {
      ...
      _createClass(ModalPage, [{
        key: "validacpf",
        value: function validacpf(strCPF) {
          var Soma;
          var Resto;
          Soma = 0;
          var i;
